...
export default function ConferenceTracks() {
  return (
    <section id="tracks" className="scroll-mt-20 mx-auto px-4 py-8 mb-12">
      {/* Section Title */}
      ...
      <div
        id="track-details"
        className="grid md:grid-cols-2 lg:grid-cols-2 gap-6 px-5"
      >
          ...
          >
              ...
              {track.desc.map((item, index) => (
                <li key={index}>
                  <p
                    ...
                    className="text-gray-600 text-lg leading tracking-wide"
                  >
                    {item}
                  </p>
                </li>
            ...
            <div className="mt-auto flex gap-3">
              <p>
                ...
                <a
                  href={track.path}
                  download={track.fileName} // ensures file downloads instead of opening
                  className="underline"
                >
                  Download
                </a>
